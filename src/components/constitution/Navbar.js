    ...
    <div className="row justify-content-between">
        ...
        <div className="col d-flex justify-content-end">
            ...
            <p className="mb-0 d-flex">
                <a href="https://m.facebook.com/groups/200285583332803/?ref=bookmarks" className="d-flex align-items-center justify-content-center"><span className="fa fa-facebook"><i className="sr-only">Facebook</i></span></a>
...
<div className="container">
  ...
  <form action="https://www.google.com/search" method="GET" className="searchform order-lg-last" >
  <div className="form-group d-flex">
<input type="text" className="form-control pl-3" placeholder="Google Search" />
<button type="submit" placeholder="" className="form-control search"><span className="fa fa-search"></span></button>
  ...
  <div className="collapse navbar-collapse" id="ftco-nav">
    ...
    <li className="nav-item active"><a href="Constitution" className="nav-link">Constitution</a></li>
